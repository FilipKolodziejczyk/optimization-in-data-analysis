...
def makeTup(Path):
    ...
    for filename in Path:
        ...
        with open(Path[filename], 'r') as file_:
            templist = list()
            for line in file_:
                line = line.strip()
                if line != '':
...
def makeIDTup(name, sentenceTuple, wordset, wordsetTD, charset, word2ID, ID2word, word2IDTD, ID2wordTD, char2ID,
              ID2char):
...
word2ID, ID2word, word2IDTD, ID2wordTD, char2ID, ID2char = makeIDTup('NCBI', sentenceTuple, wordset, wordsetTD, charset,
                                                                     word2ID, ID2word, word2IDTD, ID2wordTD, char2ID,
                                                                     ID2char)
#BC2GM
...
sentenceTuple, wordset, wordsetTD, charset = makeTup(Path)
word2ID, ID2word, word2IDTD, ID2wordTD, char2ID, ID2char = makeIDTup('BC2GM', sentenceTuple, wordset, wordsetTD,
                                                                     charset, word2ID, ID2word, word2IDTD, ID2wordTD,
                                                                     char2ID, ID2char)
#BC4CHEMD
...
sentenceTuple, wordset, wordsetTD, charset = makeTup(Path)
word2ID, ID2word, word2IDTD, ID2wordTD, char2ID, ID2char = makeIDTup('BC4CHEMD', sentenceTuple, wordset, wordsetTD,
                                                                     charset, word2ID, ID2word, word2IDTD, ID2wordTD,
                                                                     char2ID, ID2char)
#BC5CDR-disease
...
sentenceTuple, wordset, wordsetTD, charset = makeTup(Path)
word2ID, ID2word, word2IDTD, ID2wordTD, char2ID, ID2char = makeIDTup('BC5CDR-disease', sentenceTuple, wordset,
                                                                     wordsetTD, charset, word2ID, ID2word, word2IDTD,
                                                                     ID2wordTD, char2ID, ID2char)
#BC5CDR-chem
...
sentenceTuple, wordset, wordsetTD, charset = makeTup(Path)
word2ID, ID2word, word2IDTD, ID2wordTD, char2ID, ID2char = makeIDTup('BC5CDR-chem', sentenceTuple, wordset, wordsetTD,
                                                                     charset, word2ID, ID2word, word2IDTD, ID2wordTD,
                                                                     char2ID, ID2char)
